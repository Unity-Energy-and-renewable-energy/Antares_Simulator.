...
public:
    ...
    */
    ...
    template<class U>
    CheckpointBuffer checkpoint(const U& u) const;
    //@}
    ...
    template<class U>
    NoticeBuffer notice(const U& u) const;
    //@}
    ...
    template<class U>
    InfoBuffer info(const U& u) const;
    //@}
    ...
    template<class U>
    WarningBuffer warning(const U& u) const;
    //@}
    ...
    template<class U>
    ErrorBuffer error(const U& u) const;
    //@}
    ...
    template<class U>
    ProgressBuffer progress(const U& u) const;
    //@}
    ...
    template<class U>
    FatalBuffer fatal(const U& u) const;
    //@}
    ...
    template<class U>
    CompatibilityBuffer compatibility(const U& u) const;
    //@}
    ...
    template<class U>
    DebugBuffer debug(const U& u) const;
    //@}

    //! Start a custom verbosity level message
    template<class C>
    Private::LogImpl::Buffer<LoggerType, C, C::enabled> custom() const;

    //! Start a message with no verbosity level (always displayed)
    template<class U>
    UnknownBuffer operator<<(const U& u) const;
    //@}
...
private:
    ...
    */
    ...
    friend class Private::LogImpl::Buffer;
