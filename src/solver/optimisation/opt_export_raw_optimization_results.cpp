                                      ...
                                      std::string filename)
{
    if (problemeHebdo->exportRawOptimizationResults)
    {
        ...
        content += "OptimisationAuPasHebdomadaire(bool):\t" + std::to_string(problemeHebdo->OptimisationAuPasHebdomadaire) + "\r\n";
        ...
        content += "OptimisationAvecCoutsDeDemarrage(bool):\t" + std::to_string(problemeHebdo->OptimisationAvecCoutsDeDemarrage) + "\r\n";
        content += "OptimisationAvecVariablesEntieres(bool):\t" + std::to_string(problemeHebdo->OptimisationAvecVariablesEntieres) + "\r\n";
        ...
        content += "exportRawOptimizationResults(bool):\t" + std::to_string(problemeHebdo->exportRawOptimizationResults) + "\r\n";
        content += "HeureDansLAnnee:\t" + std::to_string(problemeHebdo->HeureDansLAnnee) + "\r\n";
        content += "LeProblemeADejaEteInstancie(bool):\t" + std::to_string(problemeHebdo->LeProblemeADejaEteInstancie) + "\r\n";
        content += "firstWeekOfSimulation(bool):\t" + std::to_string(problemeHebdo->firstWeekOfSimulation) + "\r\n";
        ...
        for (uint indexInterco = 0; indexInterco < problemeHebdo->NombreDInterconnexions; indexInterco++)
        {
            ...
            content += baseContent + "IntercoGereeAvecDesCouts(bool):\t" + std::to_string(coutDeTransport.IntercoGereeAvecDesCouts) + "\r\n";
            content += baseContent + "IntercoGereeAvecLoopFlow(bool):\t" + std::to_string(coutDeTransport.IntercoGereeAvecLoopFlow) + "\r\n";
