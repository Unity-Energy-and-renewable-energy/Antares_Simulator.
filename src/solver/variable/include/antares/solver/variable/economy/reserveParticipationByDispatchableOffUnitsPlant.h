...
public:
    ...
    //! Ancestor
    typedef Variable::IVariable<ReserveParticipationByDispatchableOffUnitsPlant<NextT>, NextT, VCardType>
      AncestorType;
...
public:
    ReserveParticipationByDispatchableOffUnitsPlant() : pValuesForTheCurrentYear(NULL), pSize(0)
    {
    }
