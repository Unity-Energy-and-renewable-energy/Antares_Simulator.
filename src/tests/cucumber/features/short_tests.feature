Feature: short tests
  ...
  @fast @short @ts-generator
  Scenario: 009 TS generation - Thermal power
    Given the study path is "short-tests/009 TS generation - Thermal power"
    When I run timeseries generation on all thermal clusters
    Then the execution succeeds
    And in area "ther node", 200 TS are generated for thermal cluster "base"
    And in area "ther node", the generated TS for thermal cluster "base" respects a forced outage of 5% and a planned outage of 10%
    And in area "ther node", 200 TS are generated for thermal cluster "semi"
    And in area "ther node", the generated TS for thermal cluster "semi" respects a forced outage of 5% and a planned outage of 10%
    And in area "ther node", 200 TS are generated for thermal cluster "peak"
    And in area "ther node", the generated TS for thermal cluster "peak" respects a forced outage of 5% and a planned outage of 10%
